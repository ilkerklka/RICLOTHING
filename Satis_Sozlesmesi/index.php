...
<head>
    ...
    ></script>
    <title>RI CLOTHING - Satış Sözleşmesi</title>
...
<p>Kullanma talimatına uygun şekilde kullanılan ve temizliği yapılan &uuml;r&uuml;nler her t&uuml;rl&uuml; &uuml;retim hatasına karşı aşağıda belirtilen şartlar dahilinde 2 yıl garantilidir: Satıcının garanti sorumluluğu yalnızca 4077 sayılı kanun kapsamına giren t&uuml;keticiler i&ccedil;in ge&ccedil;erlidir. Ticari nitelikteki işler i&ccedil;in T&uuml;rk Ticaret Kanununu h&uuml;k&uuml;mleri ge&ccedil;erli olacaktır.</p>
<p>Madde 11- Gizlilik</p>
<p>Alıcı tarafından iş bu s&ouml;zleşmede belirtilen bilgiler ile &ouml;deme yapmak amacı ile satıcıya bildirdiği bilgiler satıcı tarafından 3. şahıslarla paylaşılmayacaktır.<br />Satıcı bu bilgileri sadece idari/ yasal zorunluluğun mevcudiyeti &ccedil;er&ccedil;evesinde a&ccedil;ıklayabilecektir. Araştırma ehliyeti belgelenmiş her t&uuml;rl&uuml; adli soruşturma dahilinde satıcı kendisinden istenen bilgiyi elinde bulunduruyorsa ilgili makama sağlayabilir.</p>
<p>Kredi Kartı bilgileri kesinlikle saklanmaz,Kredi Kartı bilgileri sadece tahsilat işlemi sırasında ilgili bankalara g&uuml;venli bir şekilde iletilerek provizyon alınması i&ccedil;in kullanılır ve provizyon sonrası sistemden silinir.<br />Alıcıya ait e-posta adresi, posta adresi ve telefon gibi bilgiler yalnızca satıcı tarafından standart &uuml;r&uuml;n teslim ve bilgilendirme prosed&uuml;rleri i&ccedil;in kullanılır. Bazı d&ouml;nemlerde kampanya bilgileri, yeni &uuml;r&uuml;nler hakkında bilgiler, promosyon bilgileri alıcıya onayı sonrasında g&ouml;nderilebilir.</p>
<p>Madde 12- Uyuşmazlık Durumunda Yetkili Mahkeme ve İcra Daireleri</p>
<p>İşbu s&ouml;zleşmenin uygulanmasından kaynaklanan uyuşmazlık halinde, Sanayi ve Ticaret Bakanlığınca her yıl Aralık ayında ilan edilen değere kadar T&uuml;ketici Hakem Heyetleri ile Alıcı&rsquo;nın veya Satıcı&rsquo;nın yerleşim yerindeki T&uuml;ketici Mahkemeleri yetkilidir.</p>
<p>Siparişin ger&ccedil;ekleşmesi durumunda Alıcı işbu s&ouml;zleşmenin t&uuml;m koşullarını kabul etmiş sayılır. &hellip;/&hellip;/&hellip;</p>
</div>
<footer class="hakfooter bg-light text-center text-lg-start">
    <!-- Grid container -->
    <div class="container p-4">
      ...
      <div class="row">
        <!--Grid column-->
        <div
          class="footerfoto col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4"
        >
          <!-- Content -->
        ...
        <!--Grid column-->
        <div class="hakfoot col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
          <h5 class="text-uppercase">Haydi Bizimle Giyin</h5>
          <br /><br />
          <p>
            <a href="../Kayit_ol/" class="">Kayıt Ol</a>
          </p>
          <p>
            <a href="../giris_yap/" class="">Giriş Yap</a>
          </p>
        </div>
        <!--Grid column-->
      </div>
    ...
    >
      © 2022 :
      <a class="text-dark" href="#!">RICLOTHING Türkiye</a>
    </div>
    <!-- Copyright -->
  </footer>
</body>
