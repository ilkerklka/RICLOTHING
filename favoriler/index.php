...
<html lang="en">
  <head>
    ...
    ></script>
    <title>RI CLOTHING - Favoriler</title>
    <link rel="preconnect" href="https://fonts.googleapis.com" />
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin />
    <link
      href="https://fonts.googleapis.com/css2?family=Barlow+Condensed:wght@100&family=News+Cycle&display=swap"
      rel="stylesheet"
    />
  </head>
      ...
      <div class="container-fluid">
        ...
        >
          ...
          <a class="navbar-brand mt-2 mt-lg-0" href="../index.html">
            <img
              src="../Fotograflar/RICLOTHİNGbeyaz.png"
              height="70"
              alt="MDB Logo"
              loading="lazy"
            />
      ...
      <div class="row mt-3">
        ...
        <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
            ...
            <div
              ...
              "
            >
              <img src="../indirim.png" class="card-img-top" alt="..." />
              <div class="card-body">
                <h5 class="card-title">Spor Ceket</h5>
                <p class="card-text">Erkek</p>
                <samp class="indirim">$55.00</samp>
        ...
        <div class="container text-center text-md-start mt-5">
          ...
          <div class="row mt-3">
            ...
            <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
              ...
              <p>
                <a href="../Gizlilik_Politikasi/" class="text-reset"
                  >Gizlilik Politikası</a
                >
              </p>
              <p>
                <a href="../Satis_Sozlesmesi/" class="text-reset"
                  >Satış Sözleşmesi</a
                >
              </p>
              <p>
